...
labels, the key or the human's checks. Rater B split two of its batches across copies of itself
sharing its context and merged the results; its files reference nothing outside the rubric and
the batches.
...
Read ONLY the rubric and these four files. Do not open anything else in that scratchpad directory or its parents: other annotators' labels and answer keys live there, and reading them voids your work. No web access.
