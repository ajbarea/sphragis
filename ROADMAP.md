...
- **2026-09-26** — The human check of rater A stops at 152 items, registered before its figures, with first-half/second-half and human-to-rater-B readings added; read after: below the model pair item by item, the same valid rate, no drift toward rater A (research log).
